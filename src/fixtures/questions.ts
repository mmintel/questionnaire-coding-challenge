...
const firstName = new SingleLineQuestion(
  'firstName',
...
const occupation = new MultipleChoiceQuestion(
  'occupation',
...
const children = new MultipleChoiceQuestion(
  'children',
...
const numberOfChildren = new SingleLineQuestion(
  'numberOfChildren',
