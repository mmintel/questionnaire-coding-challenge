...
const Questionnaire: React.FC<QuestionnaireProps> = ({
  ...
  const handleGetRecommendation = async () => {
    ...
    try {
      ...
      await authenticateUserUseCase.execute({
        ...
        numberOfChildren:
          data.children === 'yes' && data.numberOfChildren
  ...
  if (!Component) {
    return (
      <div>
        There is no corresponding component for that type of question. Did you
